...
Het insluiten van de Chat App volgt het proces voor het inbedden van een Kernapp die in wordt beschreven Begonnen > [Embedding een App](../c-getting-started/c-implementation-process/c-using-livefyre.js-to-create-customize-and-use-apps-on-your-site.md#using-livefyre-js-create-customize-apps).
...
| gehechtheidDelegate | Object | Wordt gebruikt om de typen mediabijlagen op te geven die zichtbaar zijn in de App-stream. Zie [Media beperken](../c-app-customizations/c-restrict-media.md#c_restrict_media) voor meer informatie. |
...
| controlesom | ** recommendedstring (aanbevolen) | Hiermee wordt de huidige status van de CollectionMeta aangegeven. Als deze waarde wordt gewijzigd, worden de gegevens op de server door LiveCycle bijgewerkt met de nieuwe waarden in CollectionMeta. |
| datetimeFormat | *Functie* optioneelString-object | Hiermee geeft u de datetime-indeling van gestreamde inhoud op. Zie Datum- en tijdstempels aanpassen voor meer informatie. |
...
| disableThirdPartyAnalytics | ** optionalbBoolean | Schakelt analysesystemen van derden (Quantserve en Google Analytics) uit die Livefyre kan gebruiken voor interne metingen. De standaardwaarde is false. |
...
## Een gebeurtenishandler {#concept_E7C17EFB43F24F1A8572E60C69176C6D} toevoegen
...
Voor meer informatie, en voor een lijst van beschikbare gebeurtenissen, zie [Gebeurtenissen JavaScript](../c-app-customizations/c-javascript-events.md#c_javascript_events).
