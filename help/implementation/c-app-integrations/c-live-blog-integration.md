...
| **controlesom** | *optionele* tekenreeks (aanbevolen) | Hiermee wordt de huidige status van de CollectionMeta aangegeven. Als u deze waarde wijzigt, worden de gegevens op de server door LiveCycle bijgewerkt met de nieuwe waarden in CollectionMeta. |
...
| **type** | *required* String | Het type verzameling. Moet livechat zijn. |
...
## Een gebeurtenishandler toevoegen {#concept_D835C710A7214F6D921571E0770B6BC5}
