...
| **controlesom** | *aanbevolen* tekenreeks | Hiermee wordt de huidige status van de CollectionMeta aangegeven. Als u deze waarde wijzigt, worden de gegevens op de server door LiveCycle bijgewerkt met de nieuwe waarden in CollectionMeta. |
...
| **disableThirdPartyAnalytics** | *optioneel* boolean | Schakelt analysesystemen van derden (Quantserve en Google Analytics) uit die Livefyre kan gebruiken voor interne metingen. De standaardwaarde is false. |
