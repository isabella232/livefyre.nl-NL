...
1. Klik op de pagina Apps **[!UICONTROL +New App]** en selecteer een App-type in het keuzemenu.
1. Het **[!UICONTROL New App]** dialoogvenster verschijnt. Voer een **[!UICONTROL App Title]**, selecteer een **[!UICONTROL Site]** en klik **[!UICONTROL Create]** om de pagina App Overview te openen.
...
* **[!UICONTROL Settings]**: Hiermee kunt u specifieke instellingen voor de app selecteren, zoals regels voor het toevoegen van inhoud aan de app en de typen inhoud die moeten worden weergegeven. Klik op het **[!UICONTROL Settings]** tabblad om de instellingen voor netwerk en site voor de app te overschrijven.
...
## Toepassingen aanpassen {#section_lvj_xlt_bbb}

U kunt het tabblad App Designer gebruiken om toepassingen te selecteren **[!UICONTROL Style]** en **[!UICONTROL Configuration]** opties te kiezen.

**[!UICONTROL Style]** De opties zijn consistent voor alle App-typen. **[!UICONTROL Configuration]** De opties variëren per app. Onder aan het venster **[!UICONTROL Style]** en **[!UICONTROL Configuration]** ziet u de versie van LiveCycle App voor uw app.

**Stijlopties selecteren**

Stijl apps voor de branding van uw site. Gebruik de **[!UICONTROL Style]** opties om de kleur en de doopvontstijlen van de app te selecteren.
...
Als er een nieuwere versie van de app bestaat, wordt er een **[!UICONTROL Update]** knop weergegeven.
...
1. Maak een mozaïek- of mediamuur-app.
   ...
   Voor informatie over de aanpassingen beschikbaar in een Mozaïek of de muur van Media, zie [Mozaïekaanpassingen](/help/using/c-about-apps/c-mosaic-app/c-mosaic-customizations.md) of de Aanpassingen [van de Muur van](../c-about-apps/c-media-wall-app/r-media-wall-customizations.md#r_media_wall_customizations)Media.
1. Open de Designer voor de app.
1. Blader naar de **[!UICONTROL Call-to-Action Button]** sectie in Designer.
1. Schakel **[!UICONTROL Call-to-Action Button]** over naar **[!UICONTROL on]**.
...
Selecteer deze optie **[!UICONTROL Exit Preview]** om terug te keren naar de ontwerpmodus.
...
>[!NOTE]
>
>Als u de selectie opheft **[!UICONTROL Sample Data]** en geen stream is ingeschakeld voor de app, wordt geen inhoud weergegeven in de modus Voorbeeld.
...
>[!NOTE]
>
>De voorvertoningsmodus is volledig interactief, zodat u de gebruikerservaring voor uw app kunt testen. Als u deze optie inschakelt, kunnen gebruikers met de voorbeeldkoppeling op de **[!UICONTROL Allow user posts]****[!UICONTROL What’s on your mind]** knop klikken en inhoud naar uw testversie posten. De Studio maakt een lijst van inhoud zoals gepost.

## App publiceren {#section_df1_smt_bbb}

App Designer slaat automatisch uw app op nadat u een wijziging hebt aangebracht. U kunt een insluitcode genereren of eerder gepubliceerde versies van deze app bijwerken **[!UICONTROL Publish]** met de huidige versie.
...
App Designer slaat automatisch de app op nadat u een wijziging hebt aangebracht en genereert een nieuwe versie voor elke wijziging. U kunt een deelvenster openen **[!UICONTROL History]** met alle versies van uw app. In de weergegeven versies worden de editor en de leeftijd van elke versie weergegeven.

De toepassingsgeschiedenis controleren:

1. Klik op een versie om deze te selecteren.
1. De voorvertoningsweergave vernieuwen.
1. Klik **[!UICONTROL Restore Version]** om de geselecteerde versie te klonen en er vanaf te werken.
1. Klik op de knop Vorige in **[!UICONTROL Version History]** om terug te keren naar uw werkconcept.
1. Klik **[!UICONTROL Share]** om een URL voor de voorvertoning te genereren.

>[!NOTE]
>
>U kunt een app niet bewerken terwijl het **[!UICONTROL Version History]** deelvenster is geopend.

Als een andere editor wijzigingen aanbrengt terwijl het browservenster geopend is, geeft LiveCyre een waarschuwingsbericht weer wanneer u de app probeert te bewerken en wordt u gevraagd of u wilt terugkeren naar uw (oudere) conceptversie. (Hiermee voorkomt u dat meerdere gelijktijdige editors per ongeluk elkaars wijzigingen negeren.) Klik **[!UICONTROL Update to Latest]** om te beginnen met werken vanuit de meest recente versie. Klik **[!UICONTROL Overwrite]** om terug te keren naar uw (oudere) werkstatus, het versienummer te verhogen van de meest recente en door te gaan met werken.
...
1. Klik in het scherm App Overview op de **[!UICONTROL </> Embed Code]** knop.
1. Vanuit het **[!UICONTROL Embed Code]** deelvenster dat wordt geopend, kopieert en plakt u het HTML-codefragment dat in uw webpagina wordt weergegeven.
...
1. Klik **[!UICONTROL Delete App]** om de app te verwijderen.
